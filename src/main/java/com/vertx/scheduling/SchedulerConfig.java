...
public class SchedulerConfig {
        ...
        public void scheduleMergeSegments(final JsonObject config, final LSMService lsmService)
                throws SchedulerException {
                var mergeScheduleConfig = config.getJsonObject("mergeSchedule");
                final var cron =
                        cronFound(mergeScheduleConfig) ? mergeScheduleConfig.getString("cron") : "0 */1 * * * ?";
