...
public class LSM {
        ...
        private static final int IN_MEMORY_RECORD_CNT_SOFT_LIMIT = 7000;
        private static final int IN_MEMORY_RECORD_CNT_HARD_LIMIT = 30000;

        public static LSMService getLsmService() {
                final var fileIOService = new FileIOService(WAL_PATH, BUFFER_SIZE,
